  ...
  return (
    <SectionWrapper className='container-main-content flex flex-col pt-28 pb-10 gap-5 mx-auto max-w-[1300px]'>
      ...
      <div className=" bg-gradient-to-br from-[#9F531B]/5 to-[#7C3E13]/10 border border-[#9F531B]/20 rounded-lg shadow-lg p-8 space-y-6">
        ...
        {/* Responsable */}
        <section>
          <h3 className="text-[#9F531B] font-bold text-xl lg:text-3xl mb-4">1. Responsable del Tratamiento</h3>
        ...
        {/* Datos Recopilados */}
        <section>
          <h3 className="text-[#9F531B] font-bold text-xl lg:text-3xl mb-4">2. Datos que Recopilamos</h3>
          <p className="text-gray-700 text-sm lg:text-base leading-relaxed">
        ...
        {/* Propósito */}
        <section>
          <h3 className="text-[#9F531B] font-bold text-xl lg:text-3xl mb-4">3. Propósito del Tratamiento</h3>
          <p className="text-gray-700 text-sm lg:text-base leading-relaxed">
        ...
        {/* Base Legal */}
        <section>
          <h3 className="text-[#9F531B] font-bold text-xl lg:text-3xl mb-4">4. Base Legal</h3>
          <p className="text-gray-700 text-sm lg:text-base leading-relaxed">
        ...
        {/* Almacenamiento */}
        <section>
          <h3 className="text-[#9F531B] font-bold text-xl lg:text-3xl mb-4">5. Almacenamiento y Seguridad</h3>
          <p className="text-gray-700 text-sm lg:text-base leading-relaxed">
        ...
        {/* Compartir Datos */}
        <section>
          <h3 className="text-[#9F531B] font-bold text-xl lg:text-3xl mb-4">6. Compartir Información</h3>
          <p className="text-gray-700 text-sm lg:text-base leading-relaxed">
        ...
        {/* Derechos */}
        <section>
          <h3 className="text-[#9F531B] font-bold text-xl lg:text-3xl mb-4">7. Tus Derechos</h3>
          <p className="text-gray-700 text-sm lg:text-base leading-relaxed">
            Tienes derecho a:
          </p>
          <ul className="list-disc list-inside text-gray-700 text-sm lg:text-base ml-4 space-y-2">
        ...
        {/* Contacto */}
        <section>
          <h3 className="text-[#9F531B] font-bold text-xl lg:text-3xl mb-4">8. Contacto para Privacidad</h3>
          <p className="text-gray-700 text-sm lg:text-base leading-relaxed">
        ...
        {/* Cambios */}
        <section>
          <h3 className="text-[#9F531B] font-bold text-xl lg:text-3xl mb-4">9. Cambios en la Política</h3>
          <p className="text-gray-700 text-sm lg:text-base leading-relaxed">
        ...
        {/* Autoridades */}
        <section>
          <h3 className="text-[#9F531B] font-bold text-xl lg:text-3xl mb-4">10. Autoridades Supervisoras</h3>
          <p className="text-gray-700 text-sm lg:text-base leading-relaxed">
