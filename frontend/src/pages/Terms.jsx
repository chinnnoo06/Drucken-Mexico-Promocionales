  ...
  return (
    <SectionWrapper className='container-main-content flex flex-col pt-28 pb-10 gap-5 mx-auto max-w-[1300px]'>
      ...
      <div className=" bg-gradient-to-br from-[#9F531B]/5 to-[#7C3E13]/10 border border-[#9F531B]/20 rounded-lg shadow-lg p-8 space-y-6">
        ...
        {/* Aceptación */}
        <section>
          <h3 className="text-[#9F531B] font-bold text-xl lg:text-3xl mb-4">1. Aceptación de Términos</h3>
        ...
        {/* Uso del Sitio */}
        <section>
          <h3 className="text-[#9F531B] font-bold text-xl lg:text-3xl mb-4">2. Uso del Sitio Web</h3>
          <ul className="list-disc list-inside text-gray-700 text-sm lg:text-base ml-4 space-y-2">
        ...
        <section>
          <h3 className="text-[#9F531B] font-bold text-xl lg:text-3xl mb-4">3. Información y Contacto</h3>
          <ul className="list-disc list-inside text-gray-700 text-sm lg:text-base ml-4 space-y-2">
        ...
        <section>
          <h3 className="text-[#9F531B] font-bold text-xl lg:text-3xl mb-4">4. Formulario de Contacto</h3>
        ...
        {/* Comunicaciones */}
        <section>
          <h3 className="text-[#9F531B] font-bold text-xl lg:text-3xl mb-4">5. Comunicaciones</h3>
        ...
        <section>
          <h3 className="text-[#9F531B] font-bold text-xl lg:text-3xl mb-4">6. Propiedad Intelectual</h3>
          <ul className="list-disc list-inside text-gray-700 text-sm lg:text-base ml-4 space-y-2">
        ...
        <section>
          <h3 className="text-[#9F531B] font-bold text-xl lg:text-3xl mb-4">7. Limitación de Responsabilidad</h3>
          <ul className="list-disc list-inside text-gray-700 text-sm lg:text-base ml-4 space-y-2">
        ...
        {/* Enlaces Externos */}
        <section>
          <h3 className="text-[#9F531B] font-bold text-xl lg:text-3xl mb-4">8. Enlaces Externos</h3>
          <ul className="list-disc list-inside text-gray-700 text-sm lg:text-base ml-4 space-y-2">
        ...
        {/* Modificaciones */}
        <section>
          <h3 className="text-[#9F531B] font-bold text-xl lg:text-3xl mb-4">9. Modificaciones</h3>
          <ul className="list-disc list-inside text-gray-700 text-sm lg:text-base ml-4 space-y-2">
        ...
        {/* Ley Aplicable */}
        <section>
          <h3 className="text-[#9F531B] font-bold text-xl lg:text-3xl mb-4">10. Ley Aplicable</h3>
          <ul className="list-disc list-inside text-gray-700 text-sm lg:text-base ml-4 space-y-2">
        ...
        {/* Contacto */}
        <section>
          <h3 className="text-[#9F531B] font-bold text-xl lg:text-3xl mb-4">11. Contacto</h3>
          <p className="text-gray-700 leading-relaxed text-sm lg:text-base">
        ...
        <section>
          <h3 className="text-[#9F531B] font-bold text-xl lg:text-3xl mb-4">12. Información de la Empresa</h3>
          <ul className="list-disc list-inside text-gray-700 text-sm lg:text-base ml-4 space-y-2">
