            ...
            <footer className="max-w-7xl mx-auto py-12 px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
                    ...
                    <div className="flex flex-col items-center lg:items-start gap-4">
                        <h3 className="text-[#9F531B] font-semibold uppercase text-lg border-b-2 border-[#9F531B] pb-2">
                            Navegación
                        </h3>
                            ...
                            [
                                ...
                                item.to ? (
                                    <NavLink
                                        ...
                                        to={item.to}
                                        className={({ isActive }) =>
                                            `relative py-1 font-medium text-sm lg:text-base transition-all duration-300 hover:translate-x-1 block text-center md:text-left w-full
                                    ...
                                    <button
                                        key={index}
                                        onClick={item.action}
                                        className="relative py-1 font-medium text-sm lg:text-base transition-all duration-300 hover:translate-x-1 block text-center md:text-left w-full
                            ...
                            [
                                ...
                                item.to ? (
                                    <NavLink
                                        ...
                                        to={item.to}
                                        className={({ isActive }) =>
                                            `relative py-1 font-medium text-sm lg:text-base transition-all duration-300 hover:translate-x-1 block text-center md:text-left
                                            ${isActive ? 'text-[#9F531B] font-semibold' : 'text-[#1A1615] hover:text-[#9F531B]'}`
                                        }
                                    >
                                        {item.text}
