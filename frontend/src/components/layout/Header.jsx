    ...
    return (
        <>
            ...
            <div className="fixed top-4 inset-x-4 z-[100] flex justify-center pointer-events-none">
                <header className={`pointer-events-auto w-full max-w-[1300px] flex justify-between items-center gap-4 px-4 lg:px-8 py-2.5 rounded-full border border-[#9F531B]/20 shadow-lg shadow-black/5 backdrop-blur-md transition-colors duration-300 ${isInicio && !scrolled ? 'bg-[#f8dcc6]/60' : 'bg-[#f8dcc6]/90'}`}>
