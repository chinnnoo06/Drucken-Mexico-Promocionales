                ...
                <div className='space-y-6 flex-1'>
                    ...
                    <div className='contact-item group'>
                        ...
                        hover:shadow-lg transition-all duration-300'>
                            ...
                            <div className='flex-1'>
                                <p className='text-[#1A1615] font-semibold text-sm lg:text-base mb-1'>Teléfono</p>
                                <p className='text-gray-700 text-xs lg:text-sm font-medium'>+52 33 1587 6207</p>
                    ...
                    <div className='contact-item group'>
                        ...
                        hover:shadow-lg transition-all duration-300'>
                            ...
                            <div className='flex-1'>
                                <p className='text-[#1A1615] font-semibold text-sm lg:text-base mb-1'>Email</p>
                                <p className='text-gray-700 text-xs lg:text-sm  font-medium'>drucken2016@hotmail.com</p>
                    ...
                    <div className='contact-item group'>
                        ...
                        hover:shadow-lg transition-all duration-300'>
                            ...
                            <div className='flex-1'>
                                <p className='text-[#1A1615] font-semibold text-sm lg:text-base mb-1'>Dirección</p>
                    ...
                    <div className='contact-item group'>
                        ...
                        hover:shadow-lg transition-all duration-300'>
                            <div className='h-[38px] w-[38px] sm:h-[42px] sm:w-[42px] md:h-[46px] md:w-[46px] lg:h-[50px] lg:w-[50px] bg-gradient-to-br from-[#9F531B] to-[#7C3E13] rounded-full 
                            flex items-center justify-center transition-transform duration-300 mt-1'>
                                <i className='fas fa-clock text-[#EEEEEF]  text-base lg:text-lg'></i>
                            </div>
                            <div className='flex-1'>
                                <p className='text-[#1A1615] font-semibold text-sm lg:text-base mb-2'>Horarios de Atención</p>
                                <div className='space-y-1'>
                                    <div className='flex justify-between items-center'>
                                        <span className='text-gray-700 text-xs lg:text-sm  font-medium'>Lunes - Viernes:</span>
                                        <span className='text-[#9F531B] text-xs lg:text-sm font-semibold'>10:00 AM - 6:00 PM</span>
                                    </div>
                                    <div className='flex justify-between items-center'>
                                        <span className='text-gray-700 text-xs lg:text-sm font-medium'>Sábado:</span>
                                        <span className='text-red-500 text-xs lg:text-sm  font-semibold'>Cerrado</span>
                                    </div>
                                    <div className='flex justify-between items-center'>
                                        <span className='text-gray-700 text-xs lg:text-sm  font-medium'>Domingo:</span>
                                        <span className='text-red-500 text-xs lg:text-sm  font-semibold'>Cerrado</span>
                                    </div>
                                </div>
                            </div>
