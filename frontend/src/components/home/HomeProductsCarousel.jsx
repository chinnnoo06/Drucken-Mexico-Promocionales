  ...
  return (
    <div className="w-full mx-auto">
      <div className="relative">
        ...
        >
          {products.map((product) => (
            ...
            >
              {/* Etiqueta destacado */}
              <span className="absolute top-1 left-1 bg-[#9F531B] text-white text-xs px-1 py-0 md:px-2 md:py-1 rounded z-10">
                {product.span}
              </span>
              ...
              <div className='w-full aspect-[3/4] relative overflow-hidden rounded-md'>
                ...
                />
                <button className="absolute inset-0 m-auto w-[80%] h-8 sm:h-9 bg-[#9F531B]/90 text-white text-xs lg:text-sm font-medium rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-200 flex items-center justify-center"
                  onClick={() => {
              ...
              <div className="p-2 sm:p-3">
                <div className='min-h-[40px]'>
                  <h3 className="text-xs lg:text-sm font-semibold leading-tight uppercase line-clamp-2">
                ...
                {product.category == "Agendas" && (
                  <div className='mt-1 sm:mt-2'>
                    <p className="text-[#9F531B] text-sm lg:text-base font-semibold">
      ...
      <Link to="/catalogo/todos/1" className='no-underline flex items-center justify-center'>
        <button className='px-3.5 py-1 text-sm md:px-5 md:py-2 lg:text-lg rounded-xl border border-[#9F531B] text-[#9F531B] hover:bg-[#9F531B] hover:text-[#EEEEEF] transition-all duration-300 hover:shadow-lg  hover:-translate-y-1  font-semibold w-[200px] sm:w-[300px]'>
          Ver más productos
        </button>
      </Link>
    </div>
